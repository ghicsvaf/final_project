...
require('config.php');
$result= mysql_query("select id,tieude,Hinh,tomtat from posts where theloai='others'");
...
<ul>
<li><a href="others.php?lang=en"><?php echo $lang['lang_en']?></a> | <a href="others.php?lang=vie"><?php echo $lang['lang_vie']?></a></li></ul>
