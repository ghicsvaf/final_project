...
require('config.php');
$result= mysql_query("select id,tieude,Hinh,tomtat from posts where theloai='thethao'");
...
<ul>
<li><a href="thethao.php?lang=en"><?php echo $lang['lang_en']?></a> | <a href="thethao.php?lang=vie"><?php echo $lang['lang_vie']?></a></li></ul>
