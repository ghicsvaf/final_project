...
require('config.php');
$result= mysql_query("select id,tieude,Hinh,tomtat from posts where theloai='giaoduc'");
...
<ul>
<li><a href="giaoduc.php?lang=en"><?php echo $lang['lang_en']?></a> | <a href="giaoduc.php?lang=vie"><?php echo $lang['lang_vie']?></a></li></ul>
