...
require('config.php');
$result= mysql_query("select id,tieude,Hinh,tomtat from posts where theloai='phapluat'");
...
<ul>
<li><a href="phapluat.php?lang=en"><?php echo $lang['lang_en']?></a> | <a href="phapluat.php?lang=vie"><?php echo $lang['lang_vie']?></a></li></ul>
