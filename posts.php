...
//require('config.php');
$result= mysql_query("select id,tieude,Hinh,tomtat from posts order by id DESC limit 10");
...
<ul>
<li><a href="posts.php?lang=en"><?php echo $lang['lang_en']?></a> | <a href="posts.php?lang=vie"><?php echo $lang['lang_vie']?></a></li></ul>
