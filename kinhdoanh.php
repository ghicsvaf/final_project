...
require('config.php');
$result= mysql_query("select id,tieude,Hinh,tomtat from posts where theloai='kinhdoanh'");
...
<ul>
<li><a href="kinhdoanh.php?lang=en"><?php echo $lang['lang_en']?></a> | <a href="kinhdoanh.php?lang=vie"><?php echo $lang['lang_vie']?></a></li></ul>
