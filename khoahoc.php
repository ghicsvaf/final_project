...
require('config.php');
$result= mysql_query("select id,tieude,Hinh,tomtat from posts where theloai='khoahoc'");
...
<ul>
<li><a href="khoahoc.php?lang=en"><?php echo $lang['lang_en']?></a> | <a href="khoahoc.php?lang=vie"><?php echo $lang['lang_vie']?></a></li></ul>
