...
require('config.php');
$result= mysql_query("select id,tieude,Hinh,tomtat from posts where theloai='xahoi'");
...
<ul>
<li><a href="Society.php?lang=en"><?php echo $lang['lang_en']?></a> | <a href="Society.php?lang=vie"><?php echo $lang['lang_vie']?></a></li></ul>
